...
* [Wisp](https://github.com/InaKrapp/whisper-locally-running) combines faster-whisper and a simple audio recorder with an intutive, multi-language graphical user interface. 
