...
* [Ctranslate2-Whisper-Converter](https://github.com/BBC-Esq/Ctranslate2-Converter) is a user friendly program to convert any Whisper model work with ```faster-whisper```.
